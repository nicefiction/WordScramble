//  ContentView.swift
// MARK: SOURCE
// ⭐️ Accessibility : https://www.hackingwithswift.com/books/ios-swiftui/fixing-word-scramble
      ...
      NavigationView {
         VStack {
            ...
            List(usedWords,
               ...
               .accessibilityElement(children: .ignore) // ⭐️
               .accessibility(label: Text("\(usedWord), \(usedWord.count) letters")) // ⭐️
            }
